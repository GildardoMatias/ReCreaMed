...
export function Citas() {
    ...
    const onFinish = (values) => {
        const monto = usuario.configuracion.costo_cita + values.tratamiento;
                ...
                {citasData.map((cita) => {
                    ...
                    return cita.fecha_cita === hoy ?
                        <li style={{ listStyleType: 'none' }} key={cita._id}>
                            <Badge status='success' text={cita.usuario ? cita.usuario.name : "Usuario No existente"} onClick={() => { setCita(cita); setIsDetailVisible(true); }} />
                        </li>
                        : <></>
    ...
    return (
        <div className='mainContainer'>
            ...
            <Modal title="Detalles de la cita" open={isDetailVisible} onOk={handleDetailOk} onCancel={handleDetailCancel} destroyOnClose
                footer={[
                    <Popconfirm
            ...
            >
                {
                    cita ?
                        <Space direction='vertical'>
                            ...
                            <Space align='center'> <UserOutlined /> {cita.usuario ? cita.usuario.name : "Usuario eliminado o no registrado"}</Space>
