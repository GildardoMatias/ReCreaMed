...
export default function DolorCreateLink() {
    ...
    const generateLink = () => {
        // let l = `https://sistema.recreamed.com/dolor_public/${usuario._id}/${selectedPatient}/${Date.now()}`
        let l = `http://localhost:3000/dolor_public/${usuario._id}/${selectedPatient}/${Date.now()}`
        setLink(l)
    }
    const copyLink = () => {
