export const diagnosticos = [
    {
        clasificacion: "Trastornos mentales orgánicos, incluyendo los sintomáticos",
        data: {
    ...
    {
        clasificacion: "Trastornos mentales y del comportamiento debidos al consumo de sustancias psicótropas",
        data: {
    ...
    {
        clasificacion: "Esquizofrenia, trastorno esquizotípico y trastorno de ideas delirantes",
        data: {
            "F20": "Esquizofrenia",
